...
## V2.0 Hermes — 专业级 RAG 引擎（已完成 ✅）

> **迭代起点：2026-06-12 / Hardening 收尾：2026-06-23**。V1.5 全链路 smoke 已通过作为底座。详细拆分见 [v2_dev_plan.md](v2_dev_plan.md)。
>
> **核心目标**：把 RAG 从"能跑通"升级为"效果可信赖"——智能切片 + BM25/RRF 混合检索 + Reranker 精排 + Citation 溯源 + RAGAS 评估 + Trace 可观测。
>
> **当前状态**：T0~T12 功能开发 + 3 批 Hardening 全部完成；3 份审查报告（[code_quality_review_2026-06-17.md](0617/code_quality_review_2026-06-17.md) + [codex-review.md](0617/codex-review.md)）主线修复项全部压完，剩余仅独立迭代项 **A.2 Qwen3-Reranker-8B 重评估**（阻塞依赖：扩文档库到 500+ chunks）。详见 [docs/0617/xiugai.md](0617/xiugai.md)。
...
### Hardening Batch（审查报告修复 3 批）

| 批次 | 范围 | 状态 | 完成日期 |
|---|---|---|---|
| Batch 1 | A P0-1~4 / P1-5~10 + B H-01~07 + M-09/10 + 本地联调发现 2 项 | ✅ 完成 | 2026-06-18 |
| Batch 2 | B M-01 (Alembic) / A P1-9 (KB 删除补偿) / B M-06 (kb_id 兜底) / B M-04 (Trace 异步) / A P2-12 (死代码) / B M-07 (top_k 边界) + B M-11 / A P1-8 / A P2-13 / A P1-11 | ✅ 完成 | 2026-06-22 |
| Batch 3 | A P2-19 (静默吞异常审视 + 全仓 BLE001 标注) / A P2-15 (4 个 hot 模块补 41 case 单测) / B L-06 (trace 列表 N+1) | ✅ 完成 | 2026-06-23 |

> **未做项说明**：A P2-16/17/18（长函数拆分 / 命名统一 / 魔法数字配置化）+ B L-01/02/03/04/05/07 在 [docs/0617/xiugai.md](0617/xiugai.md) 写明驳回/搁置理由（误判 / 性价比低 / 改动面广风险倒挂）。
