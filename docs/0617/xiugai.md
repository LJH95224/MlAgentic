...
**Batch 3 已收尾（2026-06-23）** —— A P2-19 静默吞异常审视 ✅ + A P2-15 重点模块补单测 41 case ✅ + B L-06 trace 列表 N+1 ✅；L-01/02/03/04/05/07 + P2-16/17/18 已在第四章写明驳回/搁置理由。

xiugai.md 主线项目全部压完，剩余仅独立迭代项 **A.2 Qwen3-Reranker-8B 重评估**（阻塞依赖：用户业务侧扩文档量到 500+ chunks，与 hardening 无关）。

**Batch 2 已收尾（2026-06-22）** —— 第三段 6 项全部 ✅。

**Batch 1 已收尾（2026-06-18）** —— 第一段 P0/H/P1 + B 报告 H/M 修复全部 ✅。
